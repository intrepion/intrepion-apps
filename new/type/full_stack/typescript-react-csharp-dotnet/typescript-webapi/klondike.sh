...
# type - the works
./intrepion-apps/new/common/type/full_stack/$SERVER_FRAMEWORK/$SERVER_TEMPLATE/the_works.sh $CLIENT $SERVER_FRAMEWORK $KEBOB $PASCAL $PROJECT $SERVER_REPOSITORY $SERVER_TEMPLATE
